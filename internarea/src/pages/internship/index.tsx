...
const index = () => {
    ...
    useEffect(() => {
        const fetchdata = async () => {
            try {
                const res = await axios.get("https://internshala-clone-8uer.onrender.com/api/internship")
    ...
    // Remove the state variable internshipData to avoid confusion
    // Use the static array internshipData directly for filtering and display
    useEffect(() => {
