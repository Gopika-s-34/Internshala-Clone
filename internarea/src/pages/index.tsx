...
import { ArrowUpRight, Banknote, Calendar, ChevronRight, MapPin } from "lucide-react";
    ...
    const fetchdata = async () => {
      try {
        const [internshipres, jobres] = await Promise.all([
          axios.get("https://internshala-clone-8uer.onrender.com/api/internship"),
          axios.get("https://internshala-clone-8uer.onrender.com/api/job"),
        ]);
